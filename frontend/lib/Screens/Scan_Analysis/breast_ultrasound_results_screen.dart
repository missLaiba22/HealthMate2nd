      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMeasurementRow('Total Pixels', '${measurements['total_pixel_count']} pixels', Colors.blue),
            _buildMeasurementRow('Segmented Pixels', '${measurements['segmented_pixel_count']} pixels', Colors.red),
          ],
        ),
      ),
    );
